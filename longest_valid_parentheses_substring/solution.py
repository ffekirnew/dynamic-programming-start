class LongestValidParenthesisSubstring:
    ...
    def bottom_up(string: str) -> int:
        ...
        for index, char in enumerate(string):
            ...
            if string[index - 1] == '(': # we are making a simple valid parenthesis where the ( is right before )
                ...
                longest_valid_parenthesis_length = max(longest_valid_parenthesis_length, longest_ending_at[index])
                continue
